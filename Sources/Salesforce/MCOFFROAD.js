...
class MCOFFROAD extends BasePageActions {
    ...
    async YMIMCAUOFFROADPolicy() {
        ...
        // Now use this.selectors to access locators
            ...
            await this.safeClick(this.selectors.RoadRegisterNo, 80000, 'Road Registered - No');
            await this.page.pause();
            ...
            await this.verifyText(this.selectors.CoverageDetails3, "OFF ROAD RIDER", 30000, 'Coverage Details');
           ...
           // await this.page.pause();
            ...
            const policyKey = 'YMIMCAU-OFFROAD'; // make dynamic based on flow if needed
