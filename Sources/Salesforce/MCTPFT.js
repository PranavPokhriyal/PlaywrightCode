...
class MCTPFT extends BasePageActions {
    ...
    async YMIMCAUTPFTPolicy() {
        ...
        // Now use this.selectors to access locators
            ...
            await this.page.pause();
            await this.safeClick(this.selectors.TPFT, 60000, 'TPFT Option');
            ...
            await this.verifyText(this.selectors.CoverageDetails1, "THIRD PARTY FIRE & THEFT", 30000, 'Coverage Details');
           ...
           // await this.page.pause();
            ...
            const policyKey = 'YMIMCAU-TPFT'; // make dynamic based on flow if needed
