...
class MCTPO extends BasePageActions {
    ...
    async YMIMCAUTPOPolicy() {
        ...
        // Now use this.selectors to access locators
            ...
            await this.page.pause();
            await this.safeClick(this.selectors.TPO, 60000, 'TPO Option');
            ...
            await this.verifyText(this.selectors.BasicExcess1, "$250", 30000, 'Basic Excess Value check');
            await this.verifyText(this.selectors.CoverageDetails2, "THIRD PARTY ONLY", 30000, 'Coverage Details');
           ...
           // await this.page.pause();
            ...
            const policyKey = 'YMIMCAU-TPO'; // make dynamic based on flow if needed
