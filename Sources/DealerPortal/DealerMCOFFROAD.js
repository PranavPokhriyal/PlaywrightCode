...
class DealerMCOFFROAD extends BasePageActions {
    ...
    async DealerYMIMCAUOFFROADPolicy() {
        ...
        // Now use this.selectors to access locators
            ...
            await this.safeClick(this.selectors.MC_ROAD_REGISTER_NO, 30000, 'Select NO for Road Registered');
            await this.safeClick(this.selectors.MC_COVERAGE_TPFT, 30000, 'Select Third Party Theft Coverage');
...
module.exports = DealerMCOFFROAD;  